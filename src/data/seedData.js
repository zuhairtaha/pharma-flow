...
// تُستخدم لإملاء "قاعدة بيانات" التطبيق (ملف JSON داخل localStorage)
...
export const settings = {
  ...
  exchangeRate: 14500, // 1 دولار أمريكي = 14,500 ليرة سورية
  defaultProfitDist: 8, // هامش التوزيع الفرعي (موزّعون ثانويون وصيدليات كبرى)
  defaultProfitPharmacy: 18, // هامش البيع المباشر للصيدليات
  nearExpiryDays: 90,
  lowStockThreshold: 30,
};

// موردو الشركة (مصنّعون محليون / مستوردون)
...
// العملاء = صيدليات تشتري من الموزّع بالجملة
...
// ديون الموردين (ما ندين به للموردين)
...
// فواتير البيع بالجملة للصيدليات
export const invoices = [
  {
    id: 'inv1', number: 'INV-2026-001', customerId: 'c1', date: past(12),
    exchangeRate: 14500,
    items: [
  ...
  {
    id: 'inv2', number: 'INV-2026-002', customerId: 'c3', date: past(10),
    exchangeRate: 14500,
    items: [
  ...
  {
    id: 'inv3', number: 'INV-2026-003', customerId: 'c5', date: past(7),
    exchangeRate: 14500,
    items: [
  ...
  {
    id: 'inv4', number: 'INV-2026-004', customerId: 'c2', date: past(5),
    exchangeRate: 14500,
    items: [
  ...
  {
    id: 'inv5', number: 'INV-2026-005', customerId: 'c9', date: past(3),
    exchangeRate: 14500,
    items: [
  ...
  {
    id: 'inv6', number: 'INV-2026-006', customerId: 'c7', date: past(1),
    exchangeRate: 14500,
    items: [
  ...
  {
    id: 'inv7', number: 'INV-2026-007', customerId: 'c14', date: past(20),
    exchangeRate: 14500,
    items: [
...
// إيصالات قبض من العملاء (تسديد على الحساب)
