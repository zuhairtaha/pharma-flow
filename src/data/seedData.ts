...
export const suppliers: Supplier[] = [
  { id: 's1', name: 'مؤسسة الفارابي للصناعات الدوائية', phone: '+963-11-5551234', address: 'ريف دمشق — جرمانا', notes: 'مصنّع سوري — مضادات حيوية' },
  { id: 's2', name: 'شركة تاميكو', phone: '+963-11-5554567', address: 'دمشق — دمر', notes: 'مصنّع سوري — أدوية مزمنة' },
  { id: 's3', name: 'شركة ابن الهيثم الدوائية', phone: '+963-11-2233445', address: 'ريف دمشق — عدرا الصناعية', notes: 'مصنّع سوري' },
  { id: 's4', name: 'شركة ابن زهر', phone: '+963-11-4455667', address: 'دمشق — كفرسوسة', notes: 'مصنّع سوري' },
  { id: 's5', name: 'شركة الرازي الدوائية', phone: '+963-11-6677889', address: 'دمشق — المزة', notes: 'مصنّع سوري' },
  { id: 's6', name: 'شركة أوبري الدوائية', phone: '+963-11-8899001', address: 'ريف دمشق — حرستا', notes: 'مصنّع ومستورد — خطوط أوروبية' },
  { id: 's7', name: 'شركة ابن خلدون', phone: '+963-11-1122334', address: 'ريف دمشق — داريا', notes: 'مصنّع سوري' },
  { id: 's8', name: 'الشركة العربية للصناعات الدوائية', phone: '+963-11-2244668', address: 'ريف دمشق — عدرا الصناعية', notes: 'مصنّع سوري' },
  { id: 's9', name: 'شركة أسيا للصناعات الدوائية', phone: '+963-11-3344556', address: 'ريف دمشق — يلدا', notes: 'مصنّع سوري' },
];

export const customers: Customer[] = [
  { id: 'c1', name: 'صيدلية الميدان', owner: 'د. أحمد الحلبي', phone: '+963-944-123456', address: 'دمشق — الميدان', notes: '' },
  ...
  { id: 'c4', name: 'صيدلية المزة', owner: 'د. سلمى الشامي', phone: '+963-955-456789', address: 'دمشق — المزة فيلات الشرقية', notes: '' },
  { id: 'c5', name: 'صيدلية الزبداني', owner: 'د. خالد العلواني', phone: '+963-977-567890', address: 'ريف دمشق — الزبداني', notes: '' },
  { id: 'c6', name: 'صيدلية المهاجرين', owner: 'د. رنا الخوري', phone: '+963-922-678901', address: 'دمشق — المهاجرين', notes: '' },
  { id: 'c7', name: 'صيدلية كفرسوسة', owner: 'د. عمر العبيد', phone: '+963-966-789012', address: 'دمشق — كفرسوسة', notes: '' },
  { id: 'c8', name: 'صيدلية شعلان', owner: 'د. نور العلي', phone: '+963-944-890123', address: 'دمشق — شارع شعلان', notes: '' },
  { id: 'c9', name: 'صيدلية الصالحية', owner: 'د. سامر الدقاق', phone: '+963-933-901234', address: 'دمشق — الصالحية', notes: 'عميل كبير — طلبات شهرية' },
  { id: 'c10', name: 'صيدلية دوما المركزية', owner: 'د. هدى القاسم', phone: '+963-988-112233', address: 'ريف دمشق — دوما', notes: '' },
  { id: 'c11', name: 'صيدلية قدسيا', owner: 'د. ياسر المهنا', phone: '+963-988-223344', address: 'ريف دمشق — قدسيا', notes: '' },
  { id: 'c12', name: 'صيدلية ركن الدين', owner: 'د. غادة الكردي', phone: '+963-944-334455', address: 'دمشق — ركن الدين', notes: '' },
  { id: 'c13', name: 'صيدلية داريا', owner: 'د. محمود العلبي', phone: '+963-922-445566', address: 'ريف دمشق — داريا', notes: '' },
  { id: 'c14', name: 'موزع فرعي — ريف دمشق', owner: 'السيد وليد الناصر', phone: '+963-944-556677', address: 'ريف دمشق — دوما', notes: 'موزع فرعي، يأخذ بهامش الجملة' },
];
